...
print("0 _ Single")
print("1 _ Married Filing Jointly or Qualified Widow(er)")
print("2 _ Married Filing Separately")
print( "3 _ Head of Household")
...
elif status == 1: # Married filing Jointly or Qualified Widow(er)
    if income <= 16700:
        tax =  income * 0.10
    elif income <= 67900:
